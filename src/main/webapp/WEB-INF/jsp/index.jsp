								...
								<c:if test="${currentPage-1>=0}">
									...
									<c:choose>
										<c:when test="${currentPage > 1}">
											<li><a href="/indexpage/1">First</a></li>
											<li><a href="/indexpage/${currentPage - 1}">Pre</a></li>
										</c:when>
										<c:otherwise>
									...
									<c:choose>
									<c:when test="${currentPage < totalPages}">
										<li><a href="/indexpage/${currentPage + 1}}">Next</a></li>
										<li><a href="/indexpage/${totalPages}">Last</a></li>
									</c:when>
									<c:otherwise>
										<li><a href="#">Next</a></li>
										<li><a href="#">Last</a></li>
